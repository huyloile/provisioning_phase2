...
do_pull_init(Session,Target) ->
    ...
    case catch  svc_ussd:pull_init(Session,  SCPart, "", "pullinit_test", pssr, "#system_failure", [$* | Target]) of
	{page,Session2,Page} -> 
...
vlr_to_country("229" ++ _) -> "Bénin";
vlr_to_country("230" ++ _) -> "Maurice";
vlr_to_country("231" ++ _) -> "Libéria";
vlr_to_country("232" ++ _) -> "Sierra Leone";
vlr_to_country("233" ++ _) -> "Ghana";
vlr_to_country("234" ++ _) -> "Nigéria";
vlr_to_country("235" ++ _) -> "Tchad";
vlr_to_country("236" ++ _) -> "République Centrafricaine";
vlr_to_country("237" ++ _) -> "Cameroun";
vlr_to_country("238" ++ _) -> "Cap-Vert";
vlr_to_country("239" ++ _) -> "Sao Tomé-et-Principe";
vlr_to_country("240" ++ _) -> "Guinée équatoriale";
vlr_to_country("241" ++ _) -> "République Gabonaise";
vlr_to_country("242" ++ _) -> "Congo";
vlr_to_country("243" ++ _) -> "République démocratique du Congo";
vlr_to_country("244" ++ _) -> "Angola";
vlr_to_country("245" ++ _) -> "Guinée-Bissau";
...
vlr_to_country("27" ++ _)  -> "République Sudafricaine";
vlr_to_country("290" ++ _) -> "Sainte-Hélène";
vlr_to_country("291" ++ _) -> "Erythrée";
vlr_to_country("297" ++ _) -> "Aruba";
vlr_to_country("298" ++ _) -> "Iles Féroé";
vlr_to_country("299" ++ _) -> "Groenland";
vlr_to_country("30" ++ _)  -> "Grèce";
...
vlr_to_country("374" ++ _) -> "Arménie";
vlr_to_country("375" ++ _) -> "Bélarus";
vlr_to_country("376" ++ _) -> "Andorre";
vlr_to_country("377" ++ _) -> "Monaco";
vlr_to_country("378" ++ _) -> "Saint-Marin";
vlr_to_country("379" ++ _) -> "Cité du Vatican";
vlr_to_country("380" ++ _) -> "Ukraine";
vlr_to_country("381" ++ _) -> "Serbie et Monténegro";
vlr_to_country("385" ++ _) -> "Croatie";
vlr_to_country("386" ++ _) -> "Slovénie";
vlr_to_country("387" ++ _) -> "Bosnie-Herzégovine";
vlr_to_country("389" ++ _) -> "Ex-République yougoslave de Macédoine";
vlr_to_country("39" ++ _) -> "Italie";
vlr_to_country("40" ++ _) -> "Roumanie";
vlr_to_country("41" ++ _) -> "Suisse";
vlr_to_country("420" ++ _) -> "République tchèque";
vlr_to_country("421" ++ _) -> "République slovaque";
...
vlr_to_country("46" ++ _) -> "Suède";
vlr_to_country("47" ++ _) -> "Norvège";
...
vlr_to_country("599" ++ _) -> "Antilles néerlandaises";
vlr_to_country("60" ++ _) -> "Malaisie";
vlr_to_country("61" ++ _) -> "Australie";
vlr_to_country("62" ++ _) -> "Indonésie";
vlr_to_country("63" ++ _) -> "Philippines";
vlr_to_country("64" ++ _) -> "Nouvelle-Zélande";
vlr_to_country("65" ++ _) -> "Singapour";
vlr_to_country("66" ++ _) -> "Thaïlande";
vlr_to_country("670" ++ _) -> "Timor";
vlr_to_country("672" ++ _) -> "Territoires extérieures de l'Australie";
vlr_to_country("673" ++ _) -> "Brunéi Darussalam";
vlr_to_country("674" ++ _) -> "Nauru";
vlr_to_country("675" ++ _) -> "Papouasie-Nouvelle-Guinée";
...
vlr_to_country("684" ++ _) -> "Samoa américaines";
vlr_to_country("685" ++ _) -> "Samoa";
vlr_to_country("686" ++ _) -> "Kiribati";
vlr_to_country("687" ++ _) -> "Nouvelle-Calédonie";
vlr_to_country("688" ++ _) -> "Tuvalu";
vlr_to_country("689" ++ _) -> "Polynésie française";
vlr_to_country("690" ++ _) -> "Tokélau";
vlr_to_country("691" ++ _) -> "Micronésie";
vlr_to_country("692" ++ _) -> "Iles Marshall";
vlr_to_country("7" ++ _)   -> "Russie";
vlr_to_country("84" ++ _)  -> "Viet Nam";
vlr_to_country("850" ++ _) -> "Corée";
...
vlr_to_country("977" ++ _) -> "Népal";
vlr_to_country("98" ++ _)  -> "Iran";
vlr_to_country("992" ++ _) -> "Tadjikistan";
vlr_to_country("993" ++ _) -> "Turkménistan";
vlr_to_country("994" ++ _) -> "Azerbaïdjan";
vlr_to_country("995" ++ _) -> "Géorgie";
vlr_to_country("996" ++ _) -> "République kirghize";
vlr_to_country("998" ++ _) -> "Ouzbékistan";
vlr_to_country(_) -> "".
